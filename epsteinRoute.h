#ifndef EPSTEIN_ROUTE_H
#define EPSTEIN_ROUTE_H
...
// ================= DIALOGUE 1 =================
int epsteinD1(int ch1, Progress *p, int slot) {
...
// ================= DIALOGUE 2 =================
int epsteinD2(int ch2, Progress *p, int slot) {
    const char *txt = "epsteinDialogue.txt";
...
// ================= DIALOGUE 3 =================
int epsteinD3(int ch3, Progress *p, int slot) {
    const char *txt = "epsteinDialogue.txt";
