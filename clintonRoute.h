#ifndef CLINTON_ROUTE_H
#define CLINTON_ROUTE_H
    ...
    while (exitCh1 == 0) {
        ...
        switch (ch1) {
            ...
            default:
                ...
                p->c_inChoice = 0; // reset invalid input
                break;
        }
    }
